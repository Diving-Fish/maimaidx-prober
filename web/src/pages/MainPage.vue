    ...
    <v-container fluid :style="$vuetify.breakpoint.mobile ? 'padding:0px' : ''">
      ...
      <div class="console-grid">
        <div class="glass-card intro-card">
          ...
          <p>请开发者打一局 maimai 如何？帮助我们<a href="https://afdian.com/a/divingfish">发发电</a>好不好嘛~或者说——</p>
          <p>玩一玩我做的<a href="https://chiyuki.diving-fish.com/aether/">幻想风格 RPG 网页游戏</a>，我也会很感谢你的！！</p>
...
<style>
/* Outfit 自托管（可变字体，覆盖 300-800），避免依赖 fonts.googleapis.com */
@font-face {
  font-family: 'Outfit';
  font-style: normal;
  font-weight: 300 800;
