...
点击回车关闭上方窗口后，程序会继续运行。之后，将 [刚刚生成的成绩导入 Token](/docs/intro.md#完成设置并生成导入-token) 复制到对话框中（鼠标右键 / Ctrl + V），然后单击回车：

![](/img/import-token.png)

如果软件提示如下，则代表成功启动：

```
正在校验 Token，请稍候……
2026/04/27 13:15:35 INFO: Token 校验通过！
2026/04/27 13:15:35 INFO: Token 已写入 C:\Users\DivingFish\SomePath/config.json
2026/04/27 13:15:35 INFO: 登录成功
