from access.maimai import get_profile_data as maimai_get_profile_data
from access.chunithm import get_profile_data as chunithm_get_profile_data
...
@app.route("/ci/redis_cache_status", methods=['GET'])
@ci_access_required
async def redis_cache_status():
    mai_data = await maimai_get_profile_data()
    mai_data.update(await chunithm_get_profile_data())
    return await make_response(mai_data, 200)
